...
```bash
git remote add encore encore://devotional-guide-app-gm62
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/devotional-guide-app-gm62/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/devotional-guide-app-gm62/settings/integrations/github)
